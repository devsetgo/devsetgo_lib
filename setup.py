...
setup(
    ...
    extras_require={
        "postgresql": ["asyncpg>=0.21.0", "sqlalchemy>=2.0.10,<2.0.99"],
        ...
        "endpoints": ["fastapi>=0.100.0", "pydantic[email-validator]>=2.0"],
        "fastapi": ["fastapi>=0.100.0", "pydantic[email-validator]>=2.0"],
        "all": [
            "asyncpg>=0.21.0",
