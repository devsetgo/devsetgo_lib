...
from dsg_lib.models import EmailVerification
from dsg_lib.system_tools_endpoints import create_tool_router
...
@patch("dsg_lib.system_tools_endpoints.validate_email_address")
